...
def gen_covariates(times, num_covariates):
    # Creates additional features: standardized Weekday (0-6), standardized Month (1-12)
...
if __name__ == '__main__':
    ...
    stride_size = 15    # How far to move the window each time
    num_covariates = 3  # Number of additional features
    train_start = '2022-01-01'
    train_end = '2022-08-31'
    test_start = '2022-08-25'  # Need additional 7 days as given info
    test_end = '2022-12-30'
    pred_days = 7       # Prediction horizon
    given_days = 7      # Historical data window
